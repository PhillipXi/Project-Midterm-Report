...
### **7. Project Development and AI Assistance**
During the development of this transport protocol, our team utilized several AI-powered large language models as programming assistants. These tools included Google's Gemini 2.5 Pro, OpenAI's ChatGPT, and Anthropic's Claude.
These models were instrumental in the development of all five modules (`packet.py`, `connection.py`, `protocol.py`, `sender.py`, and `receiver.py`). We used them for a variety of tasks, including:
- Generating boilerplate code for classes and functions.
- Debugging complex logical errors, such as the byte-stream vs. packet-stream mismatch between the sender and receiver.
- Identifying and correcting bugs, including handshake errors and race conditions.
- Reviewing code to ensure it adhered to our team's internal API contracts.
All code generated by these tools was critically reviewed, tested, modified, and integrated by (us) students, who are solely responsible for the final implementation and functionality of the project.
